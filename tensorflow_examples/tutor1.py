...
def tutor01():
    """
    Пример объявления константных тенсоров
    """
    logger.info("Вызов функции tf.compat.v1.disable_eager_execution() необходим для обратной совместимости с 1й версией tf")
